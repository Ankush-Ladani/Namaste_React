...
//       <h2> {RestaurantList[0].data.costForTwoString} </h2>
//     </div>
//   );
// };
...
//   return (
//     <div className="card">
//       <img src={props.link} alt="foodImg" width="350px" />
//       <h2> {props.name} </h2>
//       <h2> {props.price} </h2>
//     </div>
//   );
...
// const RestaurantCard = ({ name, link, price }) => {
//   //   const { link, name, price } = props;
//   return (
//     <div className="card">
//       <img src={link} alt="foodImg" width="350px" />
  ...
  return (
    <div className="restList">
      {/* <RestaurantCard
        ...
        price={RestaurantList[0].data.costForTwoString}
      /> */}
